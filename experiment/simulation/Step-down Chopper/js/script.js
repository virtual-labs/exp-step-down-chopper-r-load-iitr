...
instance.bind("ready", () => {
  ...
  function createParticularEnd(element_name) {
    ...
    if (element_name == "IGBT1") {
      var IGBT1T = instance.addEndpoint("IGBT1L", {
        anchor: ["Left"],
        isSource: true,
        isTarget: true,
        connector: ["Flowchart"],
      ...
      var IGBT1R = instance.addEndpoint("IGBT1R", {
        anchor: ["Right"],
        isSource: true,
        isTarget: true,
        connector: ["Flowchart"],
    ...
    if (element_name == "AM2") {
      var AM2L = instance.addEndpoint("AM2T", {
        anchor: ["Top"],
        isSource: true,
        isTarget: true,
        connector: ["Flowchart"],
      ...
      var AM2R = instance.addEndpoint("AM2B", {
        anchor: ["Bottom"],
        isSource: true,
        isTarget: true,
        connector: ["Straight"],
    ...
    if (element_name == "D1") {
      var D1L = instance.addEndpoint("D1T", {
        anchor: ["Top"],
        isSource: true,
        isTarget: true,
        connector: ["Straight"],
      ...
      var D1R = instance.addEndpoint("D1B", {
        anchor: ["Bottom"],
        isSource: true,
        isTarget: true,
        connector: ["Flowchart"],
